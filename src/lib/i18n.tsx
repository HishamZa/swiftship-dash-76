...
const dict = {
  ...
  eta: { en: "Expected arrival", ar: "الوصول المتوقع" },
  ...
  s_in_air_transit: { en: "In Air Transit", ar: "في النقل الجوي" },
  s_in_air_transit_notify: { en: "In Air Shipping", ar: "في الشحن الجوي" },
  shipmentTypeLabel: { en: "Shipment Type", ar: "نوع الشحنة" },
  modeSea: { en: "SEA", ar: "بحري" },
  modeAir: { en: "AIR", ar: "جوي" },
  kg: { en: "Weight", ar: "الوزن" },
  newsTitle: { en: "Title", ar: "العنوان" },
  newsBody: { en: "Body", ar: "المحتوى" },
  ...
  deleteAddress: { en: "Delete Address", ar: "حذف العنوان" },
  addressName: { en: "Address Name", ar: "اسم العنوان" },
  addressDetails: { en: "Address Details", ar: "تفاصيل العنوان" },
  remainingDays: { en: "Days", ar: "الأيام" },
  warehouseReceivingDate: { en: "Receiving Date", ar: "تاريخ الاستلام" },
  copy: { en: "Copy", ar: "نسخ" },
  copied: { en: "Copied", ar: "تم النسخ" },
  phoneCopied: { en: "Phone number copied", ar: "تم نسخ رقم الهاتف" },
  addressCopied: { en: "Address copied", ar: "تم نسخ العنوان" },
