...
const dict = {
  ...
  loginWithPhone: { en: "Sign in with phone (or username 'Admin' for admin)", ar: "ادخل برقم هاتفك (أو 'Admin' للمسؤول)" },
  // nav
  ...
  nav_add: { en: "Add", ar: "إضافة" },
  nav_customers: { en: "Customers", ar: "العملاء" },
  nav_notify: { en: "Notify", ar: "تنبيه" },
  // tracking
  ...
  cbm: { en: "Volume (CBM)", ar: "الحجم (متر مكعب)" },
