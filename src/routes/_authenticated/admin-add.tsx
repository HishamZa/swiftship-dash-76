        ...
        <form onSubmit={submit} className="rounded-2xl border bg-card p-4 space-y-3">
          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              <Button type="button" variant="outline" size="icon" onClick={() => setTracking(generateTrackingNumber(mode))}>
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <div>
              <label className="text-xs text-muted-foreground">{t(measureKey(mode))} ({mode === "air" ? "KG" : "CBM"})</label>
